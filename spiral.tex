...
\section{Outlook}
It would be useful to modify the filling formula \eqref{eqn:g} such,
that disks with radius $\Delta s/2$ on the sample points don't overlap
the periphery of the big circle.
